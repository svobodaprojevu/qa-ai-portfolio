...
| 5 | 2026-09-06 | TS-100 Onboarding: ověření dostupnosti TEST/STAGE, Swagger a API (curl), kontrola nainstalovaných nástrojů (Postman, Snipping Tool, OBS, Node, Firefox), zaškrtnutí checklistu v README, zápis do `sprint-01.md`, kostra analýzy TS-101 ze šablony | Claude Code (Fable 5.1) | Přečetl MASTER-PLAN a onboarding, spustil HTTP kontroly 8 URL, prohledal systém, upravil 4 soubory + vytvořil kostru, 1 commit + push | Zadal cíl „připrav vše, ať můžu začít", ověří zbytek ručně (Jira, login demo účtem, Firefox) | ~25 min | 10 min | Přijato vše. Zjištěno: Firefox chybí (AC 10 TS-101), Node přes fnm mimo PATH. Jira a přihlášení asistent nesmí dělat, zůstává na uživateli. |
